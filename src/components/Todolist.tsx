...
import {FilterType} from "../state/reducers/todoListsReducer";
...
const Todolist = React.memo((props: TodolistPropsType) => {
    ...
    // Якшо у тудуліста властивість filter = Active, то фільтруємо
    if (props.filter === "Active") {
        tasksFilter = props.tasks.filter((elem) => elem.status === TaskStatuses.new);
    }
    // Якшо у тудуліста властивість filter = Completed, то фільтруємо
    if (props.filter === "Completed") {
        tasksFilter = props.tasks.filter((elem) => elem.status === TaskStatuses.completed);
    }
    //--------------------------------------------------------------------
